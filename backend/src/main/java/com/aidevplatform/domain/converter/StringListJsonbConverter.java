...
/**
 * JPA AttributeConverter that persists List&lt;String&gt; as a JSONB column value.
 */
@Converter
@Slf4j
public class StringListJsonbConverter implements AttributeConverter<List<String>, String> {
    ...
    public String convertToDatabaseColumn(List<String> attribute) {
        ...
        try {
            ...
            log.error("Failed to serialize string list to JSONB", e);
            return "[]";
        }
    }
    ...
    public List<String> convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            log.error("Failed to deserialize JSONB to string list: {}", dbData, e);
            return new ArrayList<>();
        }
    }
}
